...
@parametrizable
class UnetTrain(LightningTrain):
    """
    ...
    def __init__(
        ...
        data_shape: Tuple[int, int, int] = (1, 128, 128),
...
@parametrizable
class UnetEvaluate(RegressorEvaluator):
    MODEL = "UNet"
    DATASET = "F3"
...
if __name__ == "__main__":
    auto_main({"train": UnetTrain, "evaluate": UnetEvaluate})
