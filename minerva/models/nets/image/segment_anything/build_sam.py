...
def _build_sam(
    ...
    if checkpoint is not None:
        ...
        try:
            ...
            # new_state_dict = load_from_b(sam, state_dict, image_size, vit_patch_size) # usado para vit_b
            new_state_dict = load_from_h(sam, state_dict, image_size, vit_patch_size, encoder_global_attn_indexes) # usado para vit_h
            sam.load_state_dict(new_state_dict)
    return sam, image_embedding_size

# usado para vit_b
def load_from_b(sam, state_dict, image_size, vit_patch_size):
