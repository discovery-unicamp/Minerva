...
# # Fine-tunning DeepLabV3 from TriBYOL Tune on Parihaka Dataset
...
def train():
    ...
    ckpt_file = "/workspaces/HIAAC-KR-Dev-Container/shared_data/notebooks_e_pesos/pesos/tribyol.ckpt"

    img_size = (1006, 590)          # Change this to the size of the images in the dataset
    model_name = "tribyol"       # Model name (just identifier)
    ...
    model = FromPretrained(
        ...
        ckpt_path=ckpt_file,
        strict=False,
        filter_keys=["^online_network.RN50model."],
        keys_to_rename={"online_network.RN50model.": "backbone.RN50model."},
