...
# # Fine-tunning DeepLabV3 from KENSHODENSE on Parihaka Dataset
...
def train():
    ...
    ckpt_file = "/workspaces/HIAAC-KR-Dev-Container/shared_data/notebooks_e_pesos/pesos/kenshodense.ckpt"

    img_size = (1006, 590)          # Change this to the size of the images in the dataset
    model_name = "kenshodense"       # Model name (just identifier)
